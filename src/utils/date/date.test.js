import { isSameDate, isSameDay, isSameMonth, isSameYear } from './date.js';
...
describe('Date 관련 유틸리티 테스트', () => {
  it.each([
    ...
    'isSameYear는 입력받은 두 날짜가 년도가 같을 시 true를 반환한다.',
    ({ date, otherDate }) => {
      // given
  ...
  it.each([
    ...
    'isSameYear는 입력받은 두 날짜가 년도가 다를 시 false를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    ...
    'isSameMonth는 입력받은 두 날짜가 월이 같을 시 true를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    ...
    'isSameMonth는 입력받은 두 날짜가 월이 다를 시 false를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    ...
    'isSameDay는 입력받은 두 날짜가 일이 같을 시 true를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    ...
    'isSameDay는 입력받은 두 날짜가 일이 다를 시 false를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    ...
    'isSameDate는 입력받은 두 날짜가 같을 시 true를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
  ...
  it.each([
    { date: '2023-03-01', otherDate: '2022-03-04' },
    { date: '2023-03-01', otherDate: '2024-12-11' },
    { date: '2021-03-01', otherDate: '2020-03-30' },
  ])(
    'isSameDate는 입력받은 두 날짜가 년도가 다를 시 false를 반환한다.',
    ({ date, otherDate }) => {
      // given
      const originalDate = new Date(date);
      const compareDate = new Date(otherDate);
